...
//
//
//	std::cout << "List1 pre-moveConst" << std::endl;
//	for (auto it = list1.begin(); it != list1.end(); it++)
//	{
//		std::cout << *it << std::endl;
//	}
//
//	CacheList<int> list2(std::move(list1));
//	
//	std::cout << "List1 post-moveConst" << std::endl;
//	for (auto it = list1.begin(); it != list1.end(); it++)
//	{
//		std::cout << *it << std::endl;
//	}
//
//	std::cout << "List2 post-moveConst" << std::endl;
...
//
//	std::cout << "List2 post-move" << std::endl;
//	for (auto it = list1.begin(); it != list1.end(); it++)
//	{
//		std::cout << *it << std::endl;
//	}
//
//	std::cout << "List3 post-move" << std::endl;
